...
const configDefault = {
  ...
  cognito: {
    ...
    poolId: 'us-east-1:a491003a-1d9b-4c7b-9d61-36ecf5d4f637',
  },

  lex: {
    // Default Ref Param - OLD: DFLTTOP
    refParam: '',
    ...
    initialText: 'You can ask me for help booking appointments. Just type "Book an appointment" or click on the mic and say it.',

    // instructions spoken when mic is clicked
    initialSpeechInstruction: 'Say "Book an appointment" to get started.',
    ...
    // controls to set session attribute of user inactivity for a given time in sec
    // If value 0 mins, no control
    reInitSessionAttributesTimeOut: 300,
  ...
  ui: {
    ...
    pageTitle: 'Bot Client for Members',
    ...
    // chat window title
    toolbarTitle: 'Schedule Appointments',
  ...
  CognitoMessages: CustomMessageList,
};
