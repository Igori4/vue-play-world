...
import LexWidgetMain from '@/components/LexWidgetMain';
...
const Component = {
  name: 'lex-widget-ui',
  template: '<lex-widget-main v-on="$listeners"></lex-widget-main>',
  components: { LexWidgetMain },
};
...
export class Loader {
  constructor(config = {}) {
    ...
    this.store = new VuexConstructor.Store({
      ...VuexStore,
      modules: {
