<template>
  <v-toolbar
    ...
    class="botToolbar"
  >
    <img class="botToolbar--logo" v-if="toolbarLogo" v-bind:src="toolbarLogo"/>
    ...
    <v-toolbar-title class="hidden-xs-and-down botToolbar--title">
      {{ toolbarTitle }}
    </v-toolbar-title>
...
*/
import AccountActions from './user/AccountActions';
