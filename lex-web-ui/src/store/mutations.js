...
export default {
  ...
  */
  ...
  setConfigSessionAttributes(state, sessionAttributes) {
    if (typeof sessionAttributes !== 'object') {
      console.error('sessionAttributes is not an object', sessionAttributes);
      return;
    }
    state.config.lex.sessionAttributes = sessionAttributes;
  },
  /**
  ...
  */
  ...
  pushMessage(state, message) {
    ...
    obj.text = obj.value ? obj.value : obj.text;
    state.messages.push({
   ...
   * Set the Ref Param
   */
  setRefParam(state, id) {
    state.refParam = id;
  },
  applicationStateDefault(state) {
