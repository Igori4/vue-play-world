...
export default {
  ...
  isRequest: state => state.applicationState.inRequest,
  isError: state => state.applicationState.isError,
  isSuccess: state => state.applicationState.isSuccess,
  getStateMessage: state => state.applicationState.message,
  isPopup: state => state.popup,
};
