...
- `cd` into lex-web-ui folder
- `npm install` (to install all dependencies)
- `npm install -g cross-env` (to use cross-env globally)

#### Web App

- `npm run dev` (for development server)
- `npm run build` (for build with default /bot/ directory)
- `cross-env PUBLIC_PATH=/dir_name/ npm run build` (If you want to change directory)

#### Widget

- `npm run dev-widget` (for development server)
- `npm run build-widget` (for build with default /wbot/ directory)
- `cross-env PUBLIC_PATH=/dir_name/ npm run build-widget` (If you want to change directory)
